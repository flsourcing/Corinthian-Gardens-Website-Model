# Corinthian Gardens Website

Website for Corinthian Gardens (701 Harbor).

## View as GitHub Pages

1. **Enable GitHub Pages**
   - Open the repo on GitHub: [Corinthian-Gardens-Website-Model](https://github.com/flsourcing/Corinthian-Gardens-Website-Model)
   - Go to **Settings** → **Pages** (in the left sidebar).
   - Under **Build and deployment** → **Source**, choose **Deploy from a branch**.
   - Under **Branch**, select **master** (or **main**) and **/ (root)**.
   - Click **Save**.

2. **Wait for deployment**
   - GitHub will build and deploy the site. This usually takes 1–2 minutes.
